...
docker build -q -t navarch-site:1 examples/site >/dev/null
docker save navarch-site:1 | "${COMPOSE[@]}" exec -T byo-dind docker load >/dev/null
note "navarch-site:1 loaded onto byo-dind"
